...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        // Mettre à jour le score toutes les 1.6 secondes
        ...
        // Vérifier si la touche espace est enfoncée
        bool spacePressedThisFrame = sf::Keyboard::isKeyPressed(sf::Keyboard::Space);

        // Jouer le son si la touche espace vient juste d'être relâchée
        ...
        sf::Vector2f cloudPosition = birdSprite.getPosition(); //Recup la position de la pokéball
        ...
        // Mettre à jour la position de l'oisa
        birdSpeed += 0.5;
        ...
        // Mettre à jour la position des tuyaux tah les mario
